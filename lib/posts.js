...
export async function getBlogData(id) {
  ...
  // qui dovresti accedere alla relazione (dal post all'autore)
  // e a caricare il markdown dell'autore per prendere le informazioni che ti servono
...
export async function getAuthorPosts(authorsKey){
 ...
 fileNames.forEach( (fileName) => {
    ...
    if(authorsKey===postMatter.data.authorsKey){
      result.push(postMatter)
    }
  })
  return result 
}
